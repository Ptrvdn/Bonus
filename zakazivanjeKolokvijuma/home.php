...
<body>
    ...
    <script>
       ...
       $('input[name="id_predmeta"]').on('change', function() {
        ...
        // AJAX zahtev za dobijanje podataka o prijavi po ID-ju
        $('#btn-izmeni').on('click', function() {
            let id = $('input[name="id_predmeta"]:checked').val();
            if (id) {
                $.ajax({
                    url: 'obrada.php',
                    method: 'POST',
                    ...
                    success: function(response) {
                        // Pretpostavljamo da je odgovor JSON
                        let data = JSON.parse(response);
                        $('#id_predmeta').val(data.id);
                        $('#predmet').val(data.predmet);
                        $('#katedra').val(data.katedra);
                        $('#sala').val(data.sala);
